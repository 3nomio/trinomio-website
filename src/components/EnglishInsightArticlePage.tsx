...
type EnglishInsightArticlePageProps = {
  insightSlug: string;
};
...
function getEnglishRelatedFrameworks(): readonly ContextualLink[] {
  // For English articles point toward contact and opportunity pages
  return [
    {
      label: "Explore the Costa Rica opportunity",
      href: "/en/costa-rica-opportunity",
      meta: "Capital structuring in Costa Rica's energy transition",
    },
    {
      label: "Reach out to Trinomio",
      href: "/en/contact",
      meta: "Structure your energy opportunity",
    },
    {
      label: "View full Spanish site",
      href: "/es",
      meta: "Complete thesis, glossary, and institutional insights",
    },
  ] as const;
}

export function EnglishInsightArticlePage({
  insightSlug,
  ...
  const relatedLinks = getEnglishRelatedFrameworks();
        ...
        <article>
            ...
            <div className="relative mx-auto max-w-7xl">
              ...
              <div className="max-w-5xl">
                ...
                <div className="mt-10 flex flex-wrap gap-x-5 gap-y-3 text-sm uppercase tracking-[0.16em] text-[#E2E6E9]/72">
                  <span>{formatDateEn(insight.date)}</span>
          ...
          <section className="institutional-section relative overflow-hidden bg-trinomio-navy px-5 py-20 sm:px-8 lg:py-28">
            ...
            <div className="mx-auto max-w-3xl">
              <RelatedFrameworks links={relatedLinks} />
            </div>
          </section>
            ...
            <div className="mx-auto grid max-w-5xl gap-4 md:grid-cols-2">
              {previous ? (
                <Link
                  ...
                  href={`/en/insights/${previous.slug}`}
                >
              ...
              {finalInsight && !isFinalInsight ? (
                <Link
                  ...
                  href={`/en/insights/${finalInsight.slug}`}
                >
