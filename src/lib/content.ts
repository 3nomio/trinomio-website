export const doctrine = ["Energía", "Empresa", "Capital"] as const;
...
export const collaborationAreas = [
  {
    title: "Diagnóstico de Transición",
    forWhom:
  ...
  },
  {
    ...
    forWhom:
      "Para juntas directivas e instituciones que necesitan leer riesgos extrafinancieros y capacidad de adaptación.",
    outcome:
      "Conecta transición, gobierno, gestión de riesgo y materialidad con decisiones de capital.",
  },
  {
    title: "Preparación Institucional",
    forWhom:
      "Para equipos que necesitan talleres, sesiones ejecutivas y transferencia de criterios de inversión.",
    outcome:
      "Alinea lenguaje, marcos de análisis y criterios internos para evaluar oportunidades de transición.",
  },
] as const;

export const institutionalAudiences = [
  {
    title: "Entidades Distribuidoras",
    problem:
